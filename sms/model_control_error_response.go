...
func (o *ControlErrorResponse) GetStatus() string {
...
func (o *ControlErrorResponse) GetStatusOk() (string, bool) {
	if o == nil || o.Status == nil {
		var ret string
		return ret, false
	}
...
func (o *ControlErrorResponse) HasStatus() bool {
	if o != nil && o.Status != nil {
		return true
	}
...
func (o *ControlErrorResponse) SetStatus(v string) {
	o.Status = &v
}

// GetErrorText returns the ErrorText field value if set, zero value otherwise.
func (o *ControlErrorResponse) GetErrorText() string {
...
// and a boolean to check if the value has been set.
func (o *ControlErrorResponse) GetErrorTextOk() (string, bool) {
	if o == nil || o.ErrorText == nil {
		var ret string
		return ret, false
	}
...
func (o *ControlErrorResponse) HasErrorText() bool {
	if o != nil && o.ErrorText != nil {
		return true
	}
...
func (o *ControlErrorResponse) SetErrorText(v string) {
	o.ErrorText = &v
}

type NullableControlErrorResponse struct {
	Value ControlErrorResponse
	ExplicitNull bool
}

func (v NullableControlErrorResponse) MarshalJSON() ([]byte, error) {
    switch {
    case v.ExplicitNull:
...
func (v *NullableControlErrorResponse) UnmarshalJSON(src []byte) error {
